...
-- for the past 14 days (including today up to the current minute).
...
-- Therefore this script should only be ran on initial setup when the databases/ tables are dropped
-- and recreated, or when you are sure that the "Count" table is empty for the target devices.


DO $$
DECLARE
    -- Define the 14-day period:
    -- Starts from the beginning of the day, 13 days ago.
